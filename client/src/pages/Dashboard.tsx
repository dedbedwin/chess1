...
export default function DashboardFixed() {
  ...
  // Generate dynamic chart data based on player performance
  const generateChartData = () => {
    return [
      { date: "27/09", value: 1380 },
      { date: "04/10", value: 1375 },
      { date: "11/10", value: 1385 },
      { date: "18/10", value: 1390 },
      { date: "25/10", value: 1400 },
      { date: "01/11", value: 1410 },
      { date: "04/11", value: 1420 },
      { date: "11/11", value: 1425 },
      { date: "18/11", value: 1430 },
      { date: "25/11", value: 1435 },
      { date: "02/12", value: 1440 },
      { date: "12/12", value: 1450 },
    ];
  };
  ...
  const ratingStats = [
    {
      ...
      rating: isLinked ? 1450 : "N/A",
      icon: <Clock className="w-6 h-6 text-green-400" />,
      data: generateChartData(),
    },
    {
      title: language === "pt" ? "Blitz" : "Blitz",
      rating: isLinked ? 1620 : "N/A",
      icon: <Zap className="w-6 h-6 text-yellow-400" />,
      data: generateChartData(),
    },
    {
      title: language === "pt" ? "Bullet" : "Bullet",
      rating: isLinked ? 1380 : "N/A",
  ...
  return (
    <div className="flex h-screen bg-[#2a2725] text-white">
      ...
      <div className="hidden md:flex md:w-40 lg:w-48 bg-[#1a1815] border-r border-[#4a4743] flex-col">
        {/* Logo */}
      ...
      <div className="flex-1 overflow-auto flex flex-col">
        {/* Top Bar */}
        <div className="h-16 bg-[#2a2725] border-b border-[#4a4743] flex items-center justify-between px-4 md:px-6">
          ...
          <div className="flex items-center gap-3">
            <select
              ...
              className="bg-[#3d3a35] border border-[#4a4743] rounded px-2 py-1 text-xs md:text-sm text-white"
            >
          ...
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-4">
              <Button 
                ...
                className="bg-[#3d3a35] hover:bg-[#4a4743] h-16 flex flex-col items-center justify-center gap-2 cursor-pointer"
              >
            ...
            {/* Main Content: History (4/5) + Charts (1/5) */}
            <div className="flex flex-col lg:flex-row gap-6">
              {/* Left Side: Game History (4/5) */}
              ...
              {/* Right Side: Rating Charts (1/5) */}
              <div className="w-full lg:w-1/5 space-y-4 lg:min-w-[250px]">        {ratingStats.map((stat, idx) => (
